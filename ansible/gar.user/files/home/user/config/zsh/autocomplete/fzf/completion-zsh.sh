...
fzf-cd-widget() {
  ...
  # Alterado para não aparecer no terminal
  # BUFFER="builtin cd -- ${(q)dir:a}"
  # zle accept-line

  builtin cd -- "${dir:a}" || { # Executa o cd e verifica o retorno diretamente
    local ret=$? # Captura o código de retorno do cd *aqui*
    print -r -- "fzf-cd: falha ao mudar para o diretório: $dir (código $ret)" >&2
    return $ret # Retorna o código de erro do cd
  }
