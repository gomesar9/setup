local options = {
	...
	showtabline = 1, -- only if there is at least 2 tabs open
	...
	softtabstop = 4, -- insert 2 spaces for a tab soft
	tabstop = 4, -- recommended to keep 8 (who said?)
	...
	colorcolumn = "120", -- dispay column mark
}
